...
We created count tables from the blast files. Thereby, we filtered for a similarity threshold of &ge; 85 % and summarized our counts at the genus level. For this step, we used R and a self-written function that is stored in the directory [Functions](Scripts/Functions).
