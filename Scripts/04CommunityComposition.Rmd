...
```
```{r, echo=FALSE}
if(!file.exists("Results/TaxonomicComposition")){dir.create("Results/TaxonomicComposition")}
```

We calculate Sankey diagrams to visualize the relative proportion of the 10 most abundant classes and genera of prokaryotes, algae, fungi, heterotrophic protists, and microscopic metazoa.We only show classes that constituted more than 1 % of the respective community and genera that are classified to genus level. 
