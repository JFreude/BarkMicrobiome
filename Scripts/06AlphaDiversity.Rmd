...
if(!file.exists("Results/AlphaDiversity")){dir.create("Results/AlphaDiversity")}
```
```{r}
...
We calculate the genus richness and Pielou’s Evenness and test for significant differences among tree species using a Kruskal-Wallis test and Wilcoxon post-hoc test with multiple comparisons correction according to Benjamini & Hochberg. 

```{r, fig.width=4, fig.height=3, warning=FALSE, message=FALSE, fig.show='hold', results='hide'}
