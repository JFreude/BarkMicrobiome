...
We visualize significant differences in relative abundance across all tree species with a heatmap, the color code for the highst abundance. 

```{r, echo=FALSE}
if(!file.exists("Results")){dir.create("Results")}
if(!file.exists("Results/Heatmaps")){dir.create("Results/Heatmaps")}
```
```{r, fig.width=3.7, fig.height=6.8, fig.show='hold'}
# Load statistic
...
## 02 Alpha diversity
We visualize significant differences in alpha diversity across all tree species with a heatmap. 

```{r, fig.width=2.55, fig.height=6.8, fig.show='hold'}
# Load statistic
...
Further, we visualize pairwise significant differences in alpha diversity between tree species with a heatmap. 

```{r, fig.width=4.5, fig.height=8.8, fig.show='hold'}
# Load statistic
statistic <- read.table("Results/AlphaDiversity/AlphaDiversity_Statistic.txt", 
                        header = T, sep = "\t", dec = ".")
...
## 03 Beta diversity
We visualize significant differences in beta diversity across all tree species with a heatmap. 

```{r, fig.width=2.22, fig.height=7.3, fig.show='hold'}
# Load statistic
...
Further, we visualize pairwise significant differences in beta diversity between tree species with a heatmap. 

```{r, fig.width=3.2 , fig.height=8.4, fig.show='hold'}
# Visualization
g = ggplot(statistic, 
           aes(Factor, MicrobialCommunity, color=Pvalue, fill=Pvalue)) + 
  geom_tile(lwd = 0.5, linetype = 1) +
