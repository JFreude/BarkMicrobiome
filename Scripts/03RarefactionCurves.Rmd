...
We calculated rarefaction curves to check whether we covered the entire taxonomic diversity. All rarefaction curves reached saturation, thus we continued the data analysis without normalizing for sequencing depth.
...
```
```{r, fig.width=8, fig.height=5, warning=FALSE, message=FALSE, fig.show='hold'}
#-------------------------------- 02 Visualisation ---------------------------------#
# Create plots
...
```{r, echo=FALSE}
# Save graph as plot
ggsave(paste0("Results/RarefactionCurves/RarefactionCurves.pdf"), 
